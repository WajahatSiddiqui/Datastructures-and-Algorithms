...
public class BST {
	...
	public static void iterativePostorder(TreeNode root) {
		...
		while (current != null || !s.isEmpty()) {
			if (current != null) {
				...
				if (current != root && s.peek().right == top) {
	...
	public static void iterativePostorderTwoStack(TreeNode root) {
		if (root == null) return;
	...
	public static void reverseLevelOrderDeque(TreeNode root) {
		if (root == null) return;
	...
	public static void spiralOrder(TreeNode root) {
		...
		while (!s1.isEmpty() || !s2.isEmpty()) {
			while (!s1.isEmpty()) {
				front = s1.pop();
				System.out.print(front.data + " ");
				if (front.left != null) s2.push(front.left);
				if (front.right != null) s2.push(front.right);
			}
			
			while (!s2.isEmpty()) {
				front = s2.pop();
				System.out.print(front.data + " ");
				if (front.right != null) s1.push(front.right);
				if (front.left != null) s1.push(front.left);
			}
		}
	}
	
	public static void spiralOrderDeque(TreeNode root) {
		if (root == null) return;
